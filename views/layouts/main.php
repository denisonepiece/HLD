...
<body
    <?php if (($_SERVER['REQUEST_URI'] == '/contact') || ($_SERVER['REQUEST_URI'] == '/case')): ?>style="overflow-y: scroll;" <?php endif; ?>>
<?php $this->beginBody() ?>
<div class="wrapper">
                            ...
                            <div class="navigation-right">
                                <div class="link-nav">
                                    <ul>
                                        ...
                                        ?>
                                        <li>
                                            <a href="<?= Url::to(['/site/index/']); ?>" <?php if ($_SERVER[REQUEST_URI] == '/' || $_SERVER[REQUEST_URI] == '/brif') echo 'class = "link-nav__active"' ?>>Компания</a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['/site/service/']); ?>" <?php if ($_SERVER[REQUEST_URI] == '/service') echo 'class = "link-nav__active"' ?>>Услуги</a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['/site/case/']); ?>" <?php if (($_SERVER[REQUEST_URI] == '/case') || $flag) echo 'class = "link-nav__active"' ?>>Проекты</a>
                                        </li>
                                        <li>
                                            <a href="<?= Url::to(['/site/contact/']); ?>" <?php if ($_SERVER[REQUEST_URI] == '/contact') echo 'class = "link-nav__active"' ?>>Контакты</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="info-nav">
    ...
    <?php if ($_SERVER[REQUEST_URI] == '/contact' || $_SERVER[REQUEST_URI] == '/brif') { ?>
        <footer>
            <div class="footer nobg p-style p-v3">
